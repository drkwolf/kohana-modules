...
return array(
   ...
   'auth' => array(
    ...
    /**
     * what to do when the user register 
     * @var register.enable Bool : enbale registration
     * @var register.login  Bool : auto login after registration
     * @var register.cofrim_email  Bool : send confirmation mail
     */
    'register' => array(
      'enable' => true,
      'login' => true,
    ...
    /**
     * @var roles Array : configuration of roles.
     */
    'roles' => array(
    
	 /**
       * @var roles.managed Bool :  enable disable the Role's administration
       */
      'managed' => true,

      /**
       * @var roles.default String : default role given at login
       */
      'default' => 'login',
		
		/**
		 * @var roles.required : role that must be create at the install of the application
		 * 
		 */
		'required' => array(
			1 => 'login',
      ...
      /**
       * @var roles.hidden : hidden admin roles from normal users.
       */
      'hidden'  => array (
        'tester',
        'debug',
	  ...
	  /**
	   * @var roles.unhide : role able to see hidden user and roles.
	   */
	   'unhide' => array(
	   	'developer',
	   )
     ...
     *
     * Setup:
     * - You must have the drkwolf/email module enabled (bundled in default repo)
     */
    'email' => true,
    /* change this to the email address you want the password reset emails to come from. */
    'email_address' => 'no-response@drkwolf.ch',
    /**
