...
class Kohana_Email {
  ...
  # static {{{
	 ...
	 * @return  Email
	 */
	public static function factory($subject, $message, $type = 'html')
	{
...
//   }
  ...
  # protected {{{
  /**
   * @var string type : to check if we use template
   */
  protected  $_type;

  /**
   * @var string path to template file, the file should contain subject
   */
  protected $_file;

  /**
   * @var string lang of mail (used for template)
   */
  protected $_lang;
  ...
  /**
   * @var array for local vairable (template)
   */
