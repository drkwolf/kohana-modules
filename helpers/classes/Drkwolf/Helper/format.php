...
class Drkwolf_Helper_Format {
  ...
  /** 
   * same as
   * @param mysql timestamp $time
   * return see Helper_Format::relative_time
   */
	public static function relative_stime($time)
  {
    return self::relative_time(strtotime($time));
  }
	/**
